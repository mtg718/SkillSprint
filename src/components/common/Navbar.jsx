...
import { AiOutlineMenu, AiOutlineShoppingCart, AiOutlineLogin, AiOutlineHome, AiOutlineContacts } from "react-icons/ai";
...
import logo from "../../assets/Logo/skillsprint.png";
  ...
  return (
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        {/* Logo */}
        <Link to="/">
          <img className='pt-3' src={logo} alt="Logo" width={160} height={32} loading="lazy" />
    </Link>
        {/* Navigation links */}
