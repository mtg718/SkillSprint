          ...
          {videoEnded && (
            ...
            >
              {!completedLectures.includes(subSectionId) && (  
                // video ended and not present in completed lectures array then only show mark as completed
                <IconBtn
                  disabled={loading}
